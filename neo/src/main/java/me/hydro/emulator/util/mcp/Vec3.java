...
public class Vec3
{
    ...
    public Vec3 rotatePitch(MathHelper.FastMathType type, float pitch)
    {
        float f = MathHelper.cos(type, pitch);
        float f1 = MathHelper.sin(type, pitch);
    ...
    public Vec3 rotateYaw(MathHelper.FastMathType type, float yaw)
    {
        float f = MathHelper.cos(type, yaw);
        float f1 = MathHelper.sin(type, yaw);
